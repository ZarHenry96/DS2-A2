...
\begin{document}
	...
	Is important to note that this is not the only way in which a node can leave, indeed, as described in \cref{subsec:leavingRide}, if a node is forced to leave it is removed from the active nodes, and a node in more is scheduled to join at the next join procedure.\\
